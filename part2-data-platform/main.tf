...
module "eks" {
  ...
  cluster_endpoint_public_access = true # Use VPN module for development / demo
...
# Note: AWS Auth ConfigMap is now automated below.

resource "kubernetes_config_map_v1_data" "aws_auth_roles" {
  provider = kubernetes
